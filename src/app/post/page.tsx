  ...
  return (
    <div className="p-6 max-w-4xl mx-auto bg-white shadow-md rounded mt-2">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input placeholder="Hình ảnh" type="file" accept="image/*" onChange={handleImageUpload} className="mb-4" />
        {image && <img src={image} alt="Preview" className="w-full h-[400px] object-cover mb-4 " />}
