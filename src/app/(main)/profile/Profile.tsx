    ...
    <div className="text-black dark:text-gray-100  dark:bg-[#181818] min-h-screen transition-colors">
      ...
      <div className="my-6">
        ...
        <input
          ...
          className="bg-white dark:bg-[#232c3b] w-56 rounded border-solid border-[2px] border-gray-400 dark:border-gray-700 px-2 py-1 focus:border-blue-600 focus:outline-none text-black dark:text-gray-100"
        />
      </div>
      <div className="my-6">
        <label className="block font-semibold text-slate-700 dark:text-gray-200 mb-1">
