...
import { MdOutlineEmail, MdOutlineLocalPhone, MdOutlineFacebook } from "react-icons/md";
    ...
    <div style={{ color: "#EFE3CA" }} className="w-full bg-black">
      <div className="mx-auto max-w-7xl py-4 px-4 sm:px-6 lg:px-8 opacity-70">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center my-8">
          {/* Giới thiệu về Health-Talk */}
          <div className="leading-7">
            <h3 className="font-semibold text-lg mb-2">Về H7 Life</h3>
            <p>
              H7 Life là nền tảng cung cấp kiến thức sức khỏe, tư vấn y tế và kết nối cộng đồng với các chuyên gia.
            </p>
          ...
          <div className="leading-7">
            ...
            <ul className="space-y-2">
              <li><a href="/about-us" className="hover:underline">Về chúng tôi</a></li>
              <li><a href="/articles" className="hover:underline">Bài viết sức khỏe</a></li>
              <li><a href="/" className="hover:underline">Tư vấn </a></li>
              <li><a href="/" className="hover:underline">Liên hệ</a></li>
            </ul>
          </div>

          <div className="leading-7">
            <h3 className="font-semibold text-lg mb-2">Nhận bản tin sức khỏe</h3>
            <p>Đăng ký để nhận mẹo sức khỏe và lời khuyên từ chuyên gia.</p>
            <form className="mt-2">
              <input 
                type="email" 
                placeholder="Nhập email của bạn" 
                className="p-2 rounded-md text-black w-3/4 my-2"
              />
          ...
          <div className="leading-7">
            ...
            <p className="flex items-center justify-center gap-2">
              ...
              <a href="https://www.facebook.com/hhoang7777/" target="_blank" className="hover:underline">
                H7 Life
              </a>
            </p>
          </div>
        ...
        <div className="text-center my-4">
          ...
          <p>Photography by <span className="font-semibold">Huy Hoàng</span></p>
        </div>
      </div>
    </div>
  );
